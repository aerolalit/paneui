...
/**
 * The shape of an `upload-attachment-request` frame the shim posts to the shell.
...
/**
 * The shape of a `download-attachment-request` frame the shim posts to the shell.
...
export interface PaneInitPayload {
   ...
   * the surface was created without `input_data`. The shim exposes it on the
