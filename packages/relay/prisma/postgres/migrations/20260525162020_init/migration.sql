...
CREATE TABLE "human_template_installs" (
    ...
    CONSTRAINT "human_template_installs_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "agents" ADD CONSTRAINT "agents_owner_human_id_fkey" FOREIGN KEY ("owner_human_id") REFERENCES "humans"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "humans" ADD CONSTRAINT "humans_home_template_id_fkey" FOREIGN KEY ("home_template_id") REFERENCES "templates"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "logins" ADD CONSTRAINT "logins_human_id_fkey" FOREIGN KEY ("human_id") REFERENCES "humans"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "claim_codes" ADD CONSTRAINT "claim_codes_human_id_fkey" FOREIGN KEY ("human_id") REFERENCES "humans"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "human_template_installs" ADD CONSTRAINT "human_template_installs_human_id_fkey" FOREIGN KEY ("human_id") REFERENCES "humans"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "human_template_installs" ADD CONSTRAINT "human_template_installs_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "surfaces" ADD CONSTRAINT "surfaces_owner_human_id_fkey" FOREIGN KEY ("owner_human_id") REFERENCES "humans"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "participants" ADD CONSTRAINT "participants_human_id_fkey" FOREIGN KEY ("human_id") REFERENCES "humans"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "participants" ADD CONSTRAINT "participants_agent_id_fkey" FOREIGN KEY ("agent_id") REFERENCES "agents"("id") ON DELETE SET NULL ON UPDATE CASCADE;
